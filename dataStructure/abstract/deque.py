...
class CustomerServiceCenter:
    ...
    def process_complaint(self):
        ...
        if len(self.queue) == 0:
            ...
            customer_feedback = self.queue.popleft()
            print(f'{customer_feedback.name}님의 {customer_feedback.content} 문의 내용 접수 되었습니다. 담당자가 배정되면 {customer_feedback.email}로 연락드리겠습니다!')
